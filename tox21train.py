...
from models import MolecularVAE, Predictor, LossNet
...
def main():
    ...
    for task_num in range(12):
        ...
        data_train, data_test, _ = load_tox21_dataset('data/tox21.csv', TOX21_TASKS[task_num])
        ...
        for cycle in range(CYCLES):
            ...
            task_model = Predictor(LATENT_DIM, prop_num=2).to(device)
